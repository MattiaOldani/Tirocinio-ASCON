...
void setup()
{
    ...
    for (int i = 0; i < 1000; i++)
    {
        test(0);
        Serial.print(";");
        test(MAX_DATA_LENGTH / 128);
        Serial.print(";");
        test(MAX_DATA_LENGTH / 64);
        Serial.print(";");
        test(MAX_DATA_LENGTH / 32);
        Serial.print(";");
        test(MAX_DATA_LENGTH / 16);
        Serial.print(";");
        test(MAX_DATA_LENGTH / 8);
        Serial.print(";");
        test(MAX_DATA_LENGTH / 4);
        Serial.print(";");
        test(MAX_DATA_LENGTH / 2);
        Serial.print(";");
